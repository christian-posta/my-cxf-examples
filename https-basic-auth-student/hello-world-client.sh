...
export JVM_ARGS="-Djava.util.logging.config.file=$BASE_DIR/etc/logging.properties -Dcxf.config.file=cxf-hello-world-client.xml"


echo java $JVM_ARGS helloworld.Client
