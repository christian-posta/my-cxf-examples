...
public class Client 
{
    ...
    public static void main(String[] args) {
        ...
        // TODO: Create the client-side "Service" object. 
        ...
        service = Service.create(WSDL_LOCATION, new QName("http://com.iona.ps/services/Customer", "CustomerService"));
        
        CustomerService customerService = null;
        
        // TODO: Create the customerService proxy. 
        ...
        customerService = service.getPort(new QName("http://com.iona.ps/services/Customer", "SOAPOverHTTP"), CustomerService.class);
        Customer customer = null; 
        
        // TODO: Invoke on the service proxy. 
        // Invoke on the service using the findCustomerByName() operation. Store
        // the result in the "customer" object defined above.  
        customer = customerService.findCustomerByName("Christian", "Posta");
