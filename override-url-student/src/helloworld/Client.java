...
public class Client {
	...
	public static void main(String[] args) 
	{
		...
		// TODO: Override the endpoint URL.   
		...
		//
        // note the change of PORT number
        requestContext.put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, "http://localhost:9021/helloworld");
