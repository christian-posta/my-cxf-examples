...
export JVM_ARGS="-Djava.util.logging.config.file=$BASE_DIR/etc/logging.properties -Dcxf.config.file=cxf-invoicing.xml"

echo java $JVM_ARGS invoice.Server
java $JVM_ARGS invoice.Server 
