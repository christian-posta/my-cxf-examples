...
export JVM_ARGS="-Djava.util.logging.config.file=$BASE_DIR/etc/logging.properties -Dcxf.config.file=cxf-customer-service.xml"


echo java $JVM_ARGS com.iona.ps.customer.Client
java $JVM_ARGS com.iona.ps.customer.Client 
